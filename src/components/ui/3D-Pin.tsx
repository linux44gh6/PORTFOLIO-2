...
export const PinContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative group/pin z-50 cursor-pointer w-full max-w-[18rem] h-[18rem] mx-auto",
        containerClassName
      )}
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 top-1/2 p-4 w-full h-full flex justify-center items-center rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden -translate-x-1/2 -translate-y-1/2"
        >
