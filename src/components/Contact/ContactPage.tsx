                        ...
                        <div className="  w-full  shrink-0 shadow-2xl">
                            <Form action={createContact} className=" space-y-10">
                                <div className=' flex flex-col lg:flex-row gap-4'>
                                    ...
                                    <div className="form-control">
                                        <input type="text" name="lastName" placeholder="Last Name" className="input input-bordered lg:pe-20 bg-black bordered hover:border-color1 transition-all duration-500 hover:shadow-lg hover:ring-1" required />
                                    </div>
                                </div>
                                <div className=' flex  flex-col lg:flex-row gap-4'>
                                    <div className="form-control">
